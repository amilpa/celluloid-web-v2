      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto space-y-8 animate-fade-in">
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl">
            Harness the power of collaborative AI agents to effortlessly craft compelling 
            screenplays that captivate audiences and bring your stories to life.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <Button size="lg" className="group" onClick={() => document.getElementById('create')?.scrollIntoView()}>
              Create Your Script
        ...
        <div className="p-4 md:p-8 glass-card overflow-hidden">
          <div className="h-[240px] md:h-[320px] bg-gray-900 rounded-lg flex items-center justify-center">
            <div className="text-white text-center space-y-4">
              ...
              <p className="text-sm text-gray-400">Visual representation of AI script creation</p>
            </div>
          </div>
        </div>
      </div>
